...
public class Stack {
    ...
    /**
     *  Returns the current (LIFO) objects value,mthe current objects value in Stack.
     */
    public Object peek() {
        if (lifo == null)
            return null;
    ...
    // Returns a string representation of this Stack, polymorphic nature of toString overrides of standard System.out.print behavior
